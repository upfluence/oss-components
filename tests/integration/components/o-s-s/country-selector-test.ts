...
module('Integration | Component | o-s-s/country-selector', function (hooks) {
  ...
  module('If @value is passed', function () {
    test('If the value matches an entry from the sourceList, then the input is set to the value', async function (assert) {
      await render(
        hbs`{{! @glint-nocheck }}<OSS::CountrySelector @onChange={{this.onchange}} @sourceList={{this.countries}} @value="FR" />`
      );
    ...
    test('If the component is in country mode, an alpha2 code will be matched in the @sourceList', async function (assert) {
      await render(
        hbs`{{! @glint-nocheck }}<OSS::CountrySelector @onChange={{this.onchange}} @sourceList={{this.countries}} @value="US" />`
      );
    ...
    test('If the component is in province mode, a code as @value will be matched in the @sourceList', async function (assert) {
      await render(
        hbs`{{! @glint-nocheck }}<OSS::CountrySelector @onChange={{this.onchange}} @sourceList={{this.provinces}} @value="AL" />`
      );
    ...
    test('If the component is in province mode, a province name as @value will be matched in the @sourceList', async function (assert) {
      await render(
        hbs`{{! @glint-nocheck }}<OSS::CountrySelector @onChange={{this.onchange}} @sourceList={{this.provinces}} @value="Alaska" />`
      );
