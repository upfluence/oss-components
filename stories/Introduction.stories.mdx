...
# Welcome to Upfluence's OSS design system
...
<div class="subheading">Installing</div>
...
**oss-components**. You can install it via *Yarn* or *npm* package managers :
```
yarn add upfluence-oss-components
```

<div class="subheading">About Storybook</div>

This documentation is build using Storybook, a tool that helps you build UI
components in isolation from your app's business logic, data, and context.
