...
export const monoTypography = {
  type: {
    primary: getComputedStyle(document.documentElement).getPropertyValue('--font-stack-monospace')
  },
  weight: {
    regular: '400'
  },
...
It can be set using the class `.font-stack-monospace` of the font family variable `--font-stack-monospace`.
