...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   install: function() { return /* binding */ install; },\n/* harmony export */   setup: function() { return /* binding */ setup; }\n/* harmony export */ });\n/* harmony import */ var dom_element_descriptors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dom-element-descriptors */ \"./node_modules/.pnpm/dom-element-descriptors@0.5.1/node_modules/dom-element-descriptors/dist/es/index.js\");\nfunction _typeof(o){\"@babel/helpers - typeof\";return _typeof=\"function\"==typeof Symbol&&\"symbol\"==typeof Symbol.iterator?function(o){return typeof o;}:function(o){return o&&\"function\"==typeof Symbol&&o.constructor===Symbol&&o!==Symbol.prototype?\"symbol\":typeof o;},_typeof(o);}function _classCallCheck(a,n){if(!(a instanceof n))throw new TypeError(\"Cannot call a class as a function\");}function _defineProperties(e,r){for(var t=0;t<r.length;t++){var o=r[t];o.enumerable=o.enumerable||!1,o.configurable=!0,\"value\"in o&&(o.writable=!0),Object.defineProperty(e,_toPropertyKey(o.key),o);}}function _createClass(e,r,t){return r&&_defineProperties(e.prototype,r),t&&_defineProperties(e,t),Object.defineProperty(e,\"prototype\",{writable:!1}),e;}function _defineProperty(e,r,t){return(r=_toPropertyKey(r))in e?Object.defineProperty(e,r,{value:t,enumerable:!0,configurable:!0,writable:!0}):e[r]=t,e;}function _toPropertyKey(t){var i=_toPrimitive(t,\"string\");return\"symbol\"==_typeof(i)?i:i+\"\";}function _toPrimitive(t,r){if(\"object\"!=_typeof(t)||!t)return t;var e=t[Symbol.toPrimitive];if(void 0!==e){var i=e.call(t,r||\"default\");if(\"object\"!=_typeof(i))return i;throw new TypeError(\"@@toPrimitive must return a primitive value.\");}return(\"string\"===r?String:Number)(t);}function _exists(options,message){var expectedCount=null;if(typeof options==='string'){message=options;}else if(options){expectedCount=options.count;}var elements=this.findElements();if(expectedCount===null){var result=elements.length>0;var expected=format$1(this.targetDescription);var actual=result?expected:format$1(this.targetDescription,0);if(!message){message=expected;}this.pushResult({result:result,actual:actual,expected:expected,message:message});}else if(typeof expectedCount==='number'){var _result=elements.length===expectedCount;var _actual=format$1(this.targetDescription,elements.length);var _expected=format$1(this.targetDescription,expectedCount);if(!message){message=_expected;}this.pushResult({result:_result,actual:_actual,expected:_expected,message:message});}else{throw new TypeError(\"Unexpected Parameter: \".concat(expectedCount));}}function format$1(selector,num){if(selector==='<unknown>'){selector='<not found>';}if(num===undefined||num===null){return\"Element \".concat(selector,\" exists\");}else if(num===0){return\"Element \".concat(selector,\" does not exist\");}else if(num===1){return\"Element \".concat(selector,\" exists once\");}else if(num===2){return\"Element \".concat(selector,\" exists twice\");}else{return\"Element \".concat(selector,\" exists \").concat(num,\" times\");}}// imported from https://github.com/nathanboktae/chai-dom\nfunction elementToString(el){if(!el)return'<not found>';var desc;if(el instanceof NodeList){if(el.length===0){return'empty NodeList';}desc=Array.prototype.slice.call(el,0,5).map(elementToString).join(', ');return el.length>5?\"\".concat(desc,\"... (+\").concat(el.length-5,\" more)\"):desc;}if(!(el instanceof HTMLElement||el instanceof SVGElement)){return String(el);}desc=el.tagName.toLowerCase();if(el.id){desc+=\"#\".concat(el.id);}if(el.className&&!(el.className instanceof SVGAnimatedString)){desc+=\".\".concat(String(el.className).replace(/\\s+/g,'.'));}Array.prototype.forEach.call(el.attributes,function(attr){if(attr.name!=='class'&&attr.name!=='id'){desc+=\"[\".concat(attr.name).concat(attr.value?\"=\\\"\".concat(attr.value,\"\\\"]\"):']');}});return desc;}function focused(message){var element=this.findTargetElement();if(!element)return;var result=document.activeElement===element;var actual=elementToString(document.activeElement);var expected=this.targetDescription;if(!message){message=\"Element \".concat(expected,\" is focused\");}this.pushResult({result:result,actual:actual,expected:expected,message:message});}function notFocused(message){var element=this.findTargetElement();if(!element)return;var result=document.activeElement!==element;var expected=\"Element \".concat(this.targetDescription,\" is not focused\");var actual=result?expected:\"Element \".concat(this.targetDescription,\" is focused\");if(!message){message=expected;}this.pushResult({result:result,message:message,actual:actual,expected:expected});}function checked(message){var element=this.findTargetElement();if(!element)return;var isChecked=element.checked===true;var isNotChecked=element.checked===false;var result=isChecked;var hasCheckedProp=isChecked||isNotChecked;if(!hasCheckedProp){var ariaChecked=element.getAttribute('aria-checked');if(ariaChecked!==null){result=ariaChecked==='true';}}var actual=result?'checked':'not checked';var expected='checked';if(!message){message=\"Element \".concat(this.targetDescription,\" is checked\");}this.pushResult({result:result,actual:actual,expected:expected,message:message});}function notChecked(message){var element=this.findTargetElement();if(!element)return;var isChecked=element.checked===true;var isNotChecked=element.checked===false;var result=!isChecked;var hasCheckedProp=isChecked||isNotChecked;if(!hasCheckedProp){var ariaChecked=element.getAttribute('aria-checked');if(ariaChecked!==null){result=ariaChecked!=='true';}}var actual=result?'not checked':'checked';var expected='not checked';if(!message){message=\"Element \".concat(this.targetDescription,\" is not checked\");}this.pushResult({result:result,actual:actual,expected:expected,message:message});}function required(message){var element=this.findTargetElement();if(!element)return;if(!(element instanceof HTMLInputElement||element instanceof HTMLTextAreaElement||element instanceof HTMLSelectElement)){throw new TypeError(\"Unexpected Element Type: \".concat(element.toString()));}var result=element.required===true;var actual=result?'required':'not required';var expected='required';if(!message){message=\"Element \".concat(this.targetDescription,\" is required\");}this.pushResult({result:result,actual:actual,expected:expected,message:message});}function notRequired(message){var element=this.findTargetElement();if(!element)return;if(!(element instanceof HTMLInputElement||element instanceof HTMLTextAreaElement||element instanceof HTMLSelectElement)){throw new TypeError(\"Unexpected Element Type: \".concat(element.toString()));}var result=element.required===false;var actual=!result?'required':'not required';var expected='not required';if(!message){message=\"Element \".concat(this.targetDescription,\" is not required\");}this.pushResult({result:result,actual:actual,expected:expected,message:message});}function _isValid(message){var options=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};var element=this.findTargetElement();if(!element)return;if(!(element instanceof HTMLFormElement||element instanceof HTMLInputElement||element instanceof HTMLTextAreaElement||element instanceof HTMLButtonElement||element instanceof HTMLOutputElement||element instanceof HTMLSelectElement)){throw new TypeError(\"Unexpected Element Type: \".concat(element.toString()));}var validity=element.reportValidity()===true;var result=validity===!options.inverted;var actual=validity?'valid':'not valid';var expected=options.inverted?'not valid':'valid';if(!message){message=\"Element \".concat(this.targetDescription,\" is \").concat(actual);}this.pushResult({result:result,actual:actual,expected:expected,message:message});}// Visible logic based on jQuery's\n// https://github.com/jquery/jquery/blob/4a2bcc27f9c3ee24b3effac0fbe1285d1ee23cc5/src/css/hiddenVisibleSelectors.js#L11-L13\nfunction visible(el){if(el===null)return false;if(el.offsetWidth===0||el.offsetHeight===0)return false;var clientRects=el.getClientRects();if(clientRects.length===0)return false;for(var i=0;i<clientRects.length;i++){var rect=clientRects[i];if(rect.width!==0&&rect.height!==0)return true;}return false;}function _isVisible(options,message){var expectedCount=null;if(typeof options==='string'){message=options;}else if(options){expectedCount=options.count;}var elements=this.findElements().filter(visible);if(expectedCount===null){var result=elements.length>0;var expected=format(this.targetDescription);var actual=result?expected:format(this.targetDescription,0);if(!message){message=expected;}this.pushResult({result:result,actual:actual,expected:expected,message:message});}else if(typeof expectedCount==='number'){var _result2=elements.length===expectedCount;var _actual2=format(this.targetDescription,elements.length);var _expected2=format(this.targetDescription,expectedCount);if(!message){message=_expected2;}this.pushResult({result:_result2,actual:_actual2,expected:_expected2,message:message});}else{throw new TypeError(\"Unexpected Parameter: \".concat(expectedCount));}}function format(selector,num){if(selector==='<unknown>'){selector='<not found>';}if(num===undefined||num===null){return\"Element \".concat(selector,\" is visible\");}else if(num===0){return\"Element \".concat(selector,\" is not visible\");}else if(num===1){return\"Element \".concat(selector,\" is visible once\");}else if(num===2){return\"Element \".concat(selector,\" is visible twice\");}else{return\"Element \".concat(selector,\" is visible \").concat(num,\" times\");}}function _isDisabled(message){var options=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};var inverted=options.inverted;var element=this.findTargetElement();if(!element)return;if(!(element instanceof HTMLInputElement||element instanceof HTMLTextAreaElement||element instanceof HTMLSelectElement||element instanceof HTMLButtonElement||element instanceof HTMLOptGroupElement||element instanceof HTMLOptionElement||element instanceof HTMLFieldSetElement)){throw new TypeError(\"Unexpected Element Type: \".concat(element.toString()));}var result=element.disabled===!inverted;var actual=element.disabled===false?\"Element \".concat(this.targetDescription,\" is not disabled\"):\"Element \".concat(this.targetDescription,\" is disabled\");var expected=inverted?\"Element \".concat(this.targetDescription,\" is not disabled\"):\"Element \".concat(this.targetDescription,\" is disabled\");if(!message){message=expected;}this.pushResult({result:result,actual:actual,expected:expected,message:message});}function _matchesSelector(elements,compareSelector){var failures=elements.filter(function(it){return!it.matches(compareSelector);});return failures.length;}function collapseWhitespace(string){return string.replace(/[\\t\\r\\n]/g,' ').replace(/ +/g,' ').replace(/^ /,'').replace(/ $/,'');}/**\n * Descriptor data for creating an {@link IDOMElementDescriptor} from a CSS\n * selector\n */var SelectorData=/*#__PURE__*/function(){function SelectorData(selector,rootElement){_classCallCheck(this,SelectorData);_defineProperty(this,\"selector\",void 0);_defineProperty(this,\"rootElement\",void 0);this.selector=selector;this.rootElement=rootElement;}return _createClass(SelectorData,[{key:\"element\",get:function get(){return this.rootElement.querySelector(this.selector);}},{key:\"elements\",get:function get(){return Array.from(this.rootElement.querySelectorAll(this.selector));}},{key:\"description\",get:function get(){return this.selector;}}]);}();/**\n * Descriptor data for creating an {@link IDOMElementDescriptor} from an\n * {@link Element}\n */var ElementData=/*#__PURE__*/function(){function ElementData(element){_classCallCheck(this,ElementData);_defineProperty(this,\"element\",void 0);this.element=element;}return _createClass(ElementData,[{key:\"description\",get:function get(){return elementToString(this.element);}}]);}();/**\n * Create an {@link IDOMElementDescriptor} from a target and a root element\n */function createDescriptor(target,rootElement){if(typeof target==='string'){// selector\nif(!rootElement){throw new Error('Cannot do selector-based queries without a root element');}return (0,dom_element_descriptors__WEBPACK_IMPORTED_MODULE_0__.createDescriptor)(new SelectorData(target,rootElement));}else if(target instanceof Element){// element\nreturn (0,dom_element_descriptors__WEBPACK_IMPORTED_MODULE_0__.createDescriptor)(new ElementData(target));}else if(target===null){// null, which we treat as an unmatched element, e.g.\n// `createDescriptor(document.querySelector('.does-not-exist'))`\nreturn (0,dom_element_descriptors__WEBPACK_IMPORTED_MODULE_0__.createDescriptor)({element:null,description:'<unknown>'});}else if((0,dom_element_descriptors__WEBPACK_IMPORTED_MODULE_0__.isDescriptor)(target)){// already a descriptor\nreturn target;}else{throw new TypeError(\"Unexpected Parameter: \".concat(target));}}var DOMAssertions=/*#__PURE__*/function(){function DOMAssertions(target,rootElement,testContext){_classCallCheck(this,DOMAssertions);_defineProperty(this,\"testContext\",void 0);/**\n     * The target of our assertions\n     */_defineProperty(this,\"descriptor\",void 0);/**\n     * Whether we were constructed with an element, rather than a selector or\n     * descriptor. Used to make error messages more helpful.\n     */_defineProperty(this,\"wasPassedElement\",void 0);this.testContext=testContext;this.descriptor=createDescriptor(target,rootElement);this.wasPassedElement=target instanceof Element;}/**\n     * Assert an {@link HTMLElement} (or multiple) matching the `selector` exists.\n     *\n     * @param {object?} options\n     * @param {number?} options.count\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('#title').exists();\n     * assert.dom('.choice').exists({ count: 4 });\n     *\n     * @see {@link #doesNotExist}\n     */return _createClass(DOMAssertions,[{key:\"exists\",value:function exists(){for(var _len=arguments.length,args=new Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}_exists.call.apply(_exists,[this].concat(args));return this;}/**\n     * Assert an {@link HTMLElement} matching the `selector` does not exists.\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('.should-not-exist').doesNotExist();\n     *\n     * @see {@link #exists}\n     */},{key:\"doesNotExist\",value:function doesNotExist(message){_exists.call(this,{count:0},message);return this;}/**\n     * Assert that the {@link HTMLElement} or an {@link HTMLElement} matching the\n     * `selector` is currently checked.\n     *\n     * Note: This also supports `aria-checked=\"true/false\"`.\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input.active').isChecked();\n     *\n     * @see {@link #isNotChecked}\n     */},{key:\"isChecked\",value:function isChecked(message){checked.call(this,message);return this;}/**\n     * Assert that the {@link HTMLElement} or an {@link HTMLElement} matching the\n     * `selector` is currently unchecked.\n     *\n     * Note: This also supports `aria-checked=\"true/false\"`.\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input.active').isNotChecked();\n     *\n     * @see {@link #isChecked}\n     */},{key:\"isNotChecked\",value:function isNotChecked(message){notChecked.call(this,message);return this;}/**\n     * Assert that the {@link HTMLElement} or an {@link HTMLElement} matching the\n     * `selector` is currently focused.\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input.email').isFocused();\n     *\n     * @see {@link #isNotFocused}\n     */},{key:\"isFocused\",value:function isFocused(message){focused.call(this,message);return this;}/**\n     * Assert that the {@link HTMLElement} or an {@link HTMLElement} matching the\n     * `selector` is not currently focused.\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input[type=\"password\"]').isNotFocused();\n     *\n     * @see {@link #isFocused}\n     */},{key:\"isNotFocused\",value:function isNotFocused(message){notFocused.call(this,message);return this;}/**\n     * Assert that the {@link HTMLElement} or an {@link HTMLElement} matching the\n     * `selector` is currently required.\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input[type=\"text\"]').isRequired();\n     *\n     * @see {@link #isNotRequired}\n     */},{key:\"isRequired\",value:function isRequired(message){required.call(this,message);return this;}/**\n     * Assert that the {@link HTMLElement} or an {@link HTMLElement} matching the\n     * `selector` is currently not required.\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input[type=\"text\"]').isNotRequired();\n     *\n     * @see {@link #isRequired}\n     */},{key:\"isNotRequired\",value:function isNotRequired(message){notRequired.call(this,message);return this;}/**\n     * Assert that the {@link HTMLElement} passes validation\n     *\n     * Validity is determined by asserting that:\n     *\n     * - `element.reportValidity() === true`\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('.input').isValid();\n     *\n     * @see {@link #isValid}\n     */},{key:\"isValid\",value:function isValid(message){_isValid.call(this,message);return this;}/**\n     * Assert that the {@link HTMLElement} does not pass validation\n     *\n     * Validity is determined by asserting that:\n     *\n     * - `element.reportValidity() === true`\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('.input').isNotValid();\n     *\n     * @see {@link #isValid}\n     */},{key:\"isNotValid\",value:function isNotValid(message){_isValid.call(this,message,{inverted:true});return this;}/**\n     * Assert that the {@link HTMLElement} or an {@link HTMLElement} matching the\n     * `selector` exists and is visible.\n     *\n     * Visibility is determined by asserting that:\n     *\n     * - the element's offsetWidth and offsetHeight are non-zero\n     * - any of the element's DOMRect objects have a non-zero size\n     *\n     * Additionally, visibility in this case means that the element is visible on the page,\n     * but not necessarily in the viewport.\n     *\n     * @param {object?} options\n     * @param {number?} options.count\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('#title').isVisible();\n     * assert.dom('.choice').isVisible({ count: 4 });\n     *\n     * @see {@link #isNotVisible}\n     */},{key:\"isVisible\",value:function isVisible(){for(var _len2=arguments.length,args=new Array(_len2),_key2=0;_key2<_len2;_key2++){args[_key2]=arguments[_key2];}_isVisible.call.apply(_isVisible,[this].concat(args));return this;}/**\n     * Assert that the {@link HTMLElement} or an {@link HTMLElement} matching the\n     * `selector` does not exist or is not visible on the page.\n     *\n     * Visibility is determined by asserting that:\n     *\n     * - the element's offsetWidth or offsetHeight are zero\n     * - all of the element's DOMRect objects have a size of zero\n     *\n     * Additionally, visibility in this case means that the element is visible on the page,\n     * but not necessarily in the viewport.\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('.foo').isNotVisible();\n     *\n     * @see {@link #isVisible}\n     */},{key:\"isNotVisible\",value:function isNotVisible(message){_isVisible.call(this,{count:0},message);return this;}/**\n     * Assert that the {@link HTMLElement} has an attribute with the provided `name`\n     * and optionally checks if the attribute `value` matches the provided text\n     * or regular expression.\n     *\n     * @param {string} name\n     * @param {string|RegExp|object?} value\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input.password-input').hasAttribute('type', 'password');\n     *\n     * @see {@link #doesNotHaveAttribute}\n     */},{key:\"hasAttribute\",value:function hasAttribute(name,value,message){var element=this.findTargetElement();if(!element)return this;if(arguments.length===1){value={any:true};}var actualValue=element.getAttribute(name);if(value instanceof RegExp){var result=typeof actualValue==='string'&&value.test(actualValue);var expected=\"Element \".concat(this.targetDescription,\" has attribute \\\"\").concat(name,\"\\\" with value matching \").concat(value);var actual=actualValue===null?\"Element \".concat(this.targetDescription,\" does not have attribute \\\"\").concat(name,\"\\\"\"):\"Element \".concat(this.targetDescription,\" has attribute \\\"\").concat(name,\"\\\" with value \").concat(JSON.stringify(actualValue));if(!message){message=expected;}this.pushResult({result:result,actual:actual,expected:expected,message:message});}else if(value.any===true){var _result3=actualValue!==null;var _expected3=\"Element \".concat(this.targetDescription,\" has attribute \\\"\").concat(name,\"\\\"\");var _actual3=_result3?_expected3:\"Element \".concat(this.targetDescription,\" does not have attribute \\\"\").concat(name,\"\\\"\");if(!message){message=_expected3;}this.pushResult({result:_result3,actual:_actual3,expected:_expected3,message:message});}else{var _result4=value===actualValue;var _expected4=\"Element \".concat(this.targetDescription,\" has attribute \\\"\").concat(name,\"\\\" with value \").concat(JSON.stringify(value));var _actual4=actualValue===null?\"Element \".concat(this.targetDescription,\" does not have attribute \\\"\").concat(name,\"\\\"\"):\"Element \".concat(this.targetDescription,\" has attribute \\\"\").concat(name,\"\\\" with value \").concat(JSON.stringify(actualValue));if(!message){message=_expected4;}this.pushResult({result:_result4,actual:_actual4,expected:_expected4,message:message});}return this;}/**\n     * Assert that the {@link HTMLElement} has no attribute with the provided `name`.\n     *\n     * **Aliases:** `hasNoAttribute`, `lacksAttribute`\n     *\n     * @param {string} name\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input.username').doesNotHaveAttribute('disabled');\n     *\n     * @see {@link #hasAttribute}\n     */},{key:\"doesNotHaveAttribute\",value:function doesNotHaveAttribute(name,message){var element=this.findTargetElement();if(!element)return this;var result=!element.hasAttribute(name);var expected=\"Element \".concat(this.targetDescription,\" does not have attribute \\\"\").concat(name,\"\\\"\");var actual=expected;if(!result){var value=element.getAttribute(name);actual=\"Element \".concat(this.targetDescription,\" has attribute \\\"\").concat(name,\"\\\" with value \").concat(JSON.stringify(value));}if(!message){message=expected;}this.pushResult({result:result,actual:actual,expected:expected,message:message});return this;}},{key:\"hasNoAttribute\",value:function hasNoAttribute(name,message){return this.doesNotHaveAttribute(name,message);}},{key:\"lacksAttribute\",value:function lacksAttribute(name,message){return this.doesNotHaveAttribute(name,message);}/**\n     * Assert that the {@link HTMLElement} has an ARIA attribute with the provided\n     * `name` and optionally checks if the attribute `value` matches the provided\n     * text or regular expression.\n     *\n     * @param {string} name\n     * @param {string|RegExp|object?} value\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('button').hasAria('pressed', 'true');\n     *\n     * @see {@link #doesNotHaveAria}\n     */},{key:\"hasAria\",value:function hasAria(name){for(var _len3=arguments.length,args=new Array(_len3>1?_len3-1:0),_key3=1;_key3<_len3;_key3++){args[_key3-1]=arguments[_key3];}if(args.length===0){return this.hasAttribute(\"aria-\".concat(name));}else{return this.hasAttribute.apply(this,[\"aria-\".concat(name)].concat(args));}}/**\n     * Assert that the {@link HTMLElement} has no ARIA attribute with the\n     * provided `name`.\n     *\n     * **Aliases:** `hasNoAria`, `lacksAria`\n     *\n     * @param {string} name\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('button').doesNotHaveAria('pressed');\n     *\n     * @see {@link #hasAria}\n     */},{key:\"doesNotHaveAria\",value:function doesNotHaveAria(name,message){return this.doesNotHaveAttribute(\"aria-\".concat(name),message);}},{key:\"hasNoAria\",value:function hasNoAria(name,message){return this.doesNotHaveAria(name,message);}},{key:\"lacksAria\",value:function lacksAria(name,message){return this.doesNotHaveAria(name,message);}/**\n     * Assert that the {@link HTMLElement} has a property with the provided `name`\n     * and checks if the property `value` matches the provided text or regular\n     * expression.\n     *\n     * @param {string} name\n     * @param {RegExp|any} value\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input.password-input').hasProperty('type', 'password');\n     *\n     * @see {@link #doesNotHaveProperty}\n     */},{key:\"hasProperty\",value:function hasProperty(name,value,message){var element=this.findTargetElement();if(!element)return this;var description=this.targetDescription;var actualValue=element[name];if(value instanceof RegExp){var result=value.test(String(actualValue));var expected=\"Element \".concat(description,\" has property \\\"\").concat(name,\"\\\" with value matching \").concat(value);var actual=\"Element \".concat(description,\" has property \\\"\").concat(name,\"\\\" with value \").concat(JSON.stringify(actualValue));if(!message){message=expected;}this.pushResult({result:result,actual:actual,expected:expected,message:message});}else{var _result5=value===actualValue;var _expected5=\"Element \".concat(description,\" has property \\\"\").concat(name,\"\\\" with value \").concat(JSON.stringify(value));var _actual5=\"Element \".concat(description,\" has property \\\"\").concat(name,\"\\\" with value \").concat(JSON.stringify(actualValue));if(!message){message=_expected5;}this.pushResult({result:_result5,actual:_actual5,expected:_expected5,message:message});}return this;}/**\n     *  Assert that the {@link HTMLElement} or an {@link HTMLElement} matching the\n     * `selector` is disabled.\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('.foo').isDisabled();\n     *\n     * @see {@link #isNotDisabled}\n     */},{key:\"isDisabled\",value:function isDisabled(message){_isDisabled.call(this,message);return this;}/**\n     *  Assert that the {@link HTMLElement} or an {@link HTMLElement} matching the\n     * `selector` is not disabled.\n     *\n     * **Aliases:** `isEnabled`\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('.foo').isNotDisabled();\n     *\n     * @see {@link #isDisabled}\n     */},{key:\"isNotDisabled\",value:function isNotDisabled(message){_isDisabled.call(this,message,{inverted:true});return this;}},{key:\"isEnabled\",value:function isEnabled(message){return this.isNotDisabled(message);}/**\n     * Assert that the {@link HTMLElement} has the `expected` CSS class using\n     * [`classList`](https://developer.mozilla.org/en-US/docs/Web/API/Element/classList).\n     *\n     * `expected` can also be a regular expression, and the assertion will return\n     * true if any of the element's CSS classes match.\n     *\n     * @param {string|RegExp} expected\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input[type=\"password\"]').hasClass('secret-password-input');\n     *\n     * @example\n     * assert.dom('input[type=\"password\"]').hasClass(/.*password-input/);\n     *\n     * @see {@link #doesNotHaveClass}\n     */},{key:\"hasClass\",value:function hasClass(expected,message){var element=this.findTargetElement();if(!element)return this;var actual=element.classList.toString();if(expected instanceof RegExp){var classNames=Array.prototype.slice.call(element.classList);var result=classNames.some(function(className){return expected.test(className);});if(!message){message=\"Element \".concat(this.targetDescription,\" has CSS class matching \").concat(expected);}this.pushResult({result:result,actual:actual,expected:expected,message:message});}else{var _result6=element.classList.contains(expected);if(!message){message=\"Element \".concat(this.targetDescription,\" has CSS class \\\"\").concat(expected,\"\\\"\");}this.pushResult({result:_result6,actual:actual,expected:expected,message:message});}return this;}/**\n     * Assert that the {@link HTMLElement} does not have the `expected` CSS class using\n     * [`classList`](https://developer.mozilla.org/en-US/docs/Web/API/Element/classList).\n     *\n     * `expected` can also be a regular expression, and the assertion will return\n     * true if none of the element's CSS classes match.\n     *\n     * **Aliases:** `hasNoClass`, `lacksClass`\n     *\n     * @param {string|RegExp} expected\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input[type=\"password\"]').doesNotHaveClass('username-input');\n     *\n     * @example\n     * assert.dom('input[type=\"password\"]').doesNotHaveClass(/username-.*-input/);\n     *\n     * @see {@link #hasClass}\n     */},{key:\"doesNotHaveClass\",value:function doesNotHaveClass(expected,message){var element=this.findTargetElement();if(!element)return this;var actual=element.classList.toString();if(expected instanceof RegExp){var classNames=Array.prototype.slice.call(element.classList);var result=classNames.every(function(className){return!expected.test(className);});if(!message){message=\"Element \".concat(this.targetDescription,\" does not have CSS class matching \").concat(expected);}this.pushResult({result:result,actual:actual,expected:\"not: \".concat(expected),message:message});}else{var _result7=!element.classList.contains(expected);if(!message){message=\"Element \".concat(this.targetDescription,\" does not have CSS class \\\"\").concat(expected,\"\\\"\");}this.pushResult({result:_result7,actual:actual,expected:\"not: \".concat(expected),message:message});}return this;}},{key:\"hasNoClass\",value:function hasNoClass(expected,message){return this.doesNotHaveClass(expected,message);}},{key:\"lacksClass\",value:function lacksClass(expected,message){return this.doesNotHaveClass(expected,message);}/**\n     * Assert that the [HTMLElement][] has the `expected` style declarations using\n     * [`window.getComputedStyle`](https://developer.mozilla.org/en-US/docs/Web/API/Window/getComputedStyle).\n     *\n     * @param {object} expected\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('.progress-bar').hasStyle({\n     *   opacity: 1,\n     *   display: 'block'\n     * });\n     *\n     * @see {@link #hasClass}\n     */},{key:\"hasStyle\",value:function hasStyle(expected,message){return this.hasPseudoElementStyle(null,expected,message);}/**\n     * Assert that the pseudo element for `selector` of the [HTMLElement][] has the `expected` style declarations using\n     * [`window.getComputedStyle`](https://developer.mozilla.org/en-US/docs/Web/API/Window/getComputedStyle).\n     *\n     * @param {string} selector\n     * @param {object} expected\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('.progress-bar').hasPseudoElementStyle(':after', {\n     *   content: '\";\"',\n     * });\n     *\n     * @see {@link #hasClass}\n     */},{key:\"hasPseudoElementStyle\",value:function hasPseudoElementStyle(selector,expected,message){var element=this.findTargetElement();if(!element)return this;var computedStyle=window.getComputedStyle(element,selector);var expectedProperties=Object.keys(expected);if(expectedProperties.length<=0){throw new TypeError(\"Missing style expectations. There must be at least one style property in the passed in expectation object.\");}var result=expectedProperties.every(function(property){return(computedStyle.getPropertyValue(property.toString())||computedStyle[property])===expected[property];});var actual={};expectedProperties.forEach(function(property){return actual[property]=computedStyle.getPropertyValue(property.toString())||computedStyle[property];});if(!message){var normalizedSelector=selector?selector.replace(/^:{0,2}/,'::'):'';message=\"Element \".concat(this.targetDescription).concat(normalizedSelector,\" has style \\\"\").concat(JSON.stringify(expected),\"\\\"\");}this.pushResult({result:result,actual:actual,expected:expected,message:message});return this;}/**\n     * Assert that the [HTMLElement][] does not have the `expected` style declarations using\n     * [`window.getComputedStyle`](https://developer.mozilla.org/en-US/docs/Web/API/Window/getComputedStyle).\n     *\n     * @param {object} expected\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('.progress-bar').doesNotHaveStyle({\n     *   opacity: 1,\n     *   display: 'block'\n     * });\n     *\n     * @see {@link #hasClass}\n     */},{key:\"doesNotHaveStyle\",value:function doesNotHaveStyle(expected,message){return this.doesNotHavePseudoElementStyle(null,expected,message);}/**\n     * Assert that the pseudo element for `selector` of the [HTMLElement][] does not have the `expected` style declarations using\n     * [`window.getComputedStyle`](https://developer.mozilla.org/en-US/docs/Web/API/Window/getComputedStyle).\n     *\n     * @param {string} selector\n     * @param {object} expected\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('.progress-bar').doesNotHavePseudoElementStyle(':after', {\n     *   content: '\";\"',\n     * });\n     *\n     * @see {@link #hasClass}\n     */},{key:\"doesNotHavePseudoElementStyle\",value:function doesNotHavePseudoElementStyle(selector,expected,message){var element=this.findTargetElement();if(!element)return this;var computedStyle=window.getComputedStyle(element,selector);var expectedProperties=Object.keys(expected);if(expectedProperties.length<=0){throw new TypeError(\"Missing style expectations. There must be at least one style property in the passed in expectation object.\");}var result=expectedProperties.some(function(property){return computedStyle[property]!==expected[property];});var actual={};expectedProperties.forEach(function(property){return actual[property]=computedStyle[property];});if(!message){var normalizedSelector=selector?selector.replace(/^:{0,2}/,'::'):'';message=\"Element \".concat(this.targetDescription).concat(normalizedSelector,\" does not have style \\\"\").concat(JSON.stringify(expected),\"\\\"\");}this.pushResult({result:result,actual:actual,expected:expected,message:message});return this;}/**\n     * Assert that the text of the {@link HTMLElement} or an {@link HTMLElement}\n     * matching the `selector` matches the `expected` text, using the\n     * [`textContent`](https://developer.mozilla.org/en-US/docs/Web/API/Node/textContent)\n     * attribute and stripping/collapsing whitespace.\n     *\n     * `expected` can also be a regular expression.\n     *\n     * > Note: This assertion will collapse whitespace if the type you pass in is a string.\n     * > If you are testing specifically for whitespace integrity, pass your expected text\n     * > in as a RegEx pattern.\n     *\n     * **Aliases:** `matchesText`\n     *\n     * @param {string|RegExp} expected\n     * @param {string?} message\n     *\n     * @example\n     * // <h2 id=\"title\">\n     * //   Welcome to <b>QUnit</b>\n     * // </h2>\n     *\n     * assert.dom('#title').hasText('Welcome to QUnit');\n     *\n     * @example\n     * assert.dom('.foo').hasText(/[12]\\d{3}/);\n     *\n     * @see {@link #includesText}\n     */},{key:\"hasText\",value:function hasText(expected,message){var element=this.findTargetElement();if(!element)return this;if(expected instanceof RegExp){var result=typeof element.textContent==='string'&&expected.test(element.textContent);var actual=element.textContent;if(!message){message=\"Element \".concat(this.targetDescription,\" has text matching \").concat(expected);}this.pushResult({result:result,actual:actual,expected:expected,message:message});}else if(expected.any===true){var _result8=Boolean(element.textContent);var _expected6=\"Element \".concat(this.targetDescription,\" has a text\");var _actual6=_result8?_expected6:\"Element \".concat(this.targetDescription,\" has no text\");if(!message){message=_expected6;}this.pushResult({result:_result8,actual:_actual6,expected:_expected6,message:message});}else if(typeof expected==='string'){expected=collapseWhitespace(expected);var _actual7=collapseWhitespace(element.textContent||'');var _result9=_actual7===expected;if(!message){message=\"Element \".concat(this.targetDescription,\" has text \\\"\").concat(expected,\"\\\"\");}this.pushResult({result:_result9,actual:_actual7,expected:expected,message:message});}else{throw new TypeError(\"You must pass a string or Regular Expression to \\\"hasText\\\". You passed \".concat(expected,\".\"));}return this;}},{key:\"matchesText\",value:function matchesText(expected,message){return this.hasText(expected,message);}/**\n     * Assert that the `textContent` property of an {@link HTMLElement} is not empty.\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('button.share').hasAnyText();\n     *\n     * @see {@link #hasText}\n     */},{key:\"hasAnyText\",value:function hasAnyText(message){return this.hasText({any:true},message);}/**\n     * Assert that the `textContent` property of an {@link HTMLElement} is empty.\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('div').hasNoText();\n     *\n     * @see {@link #hasNoText}\n     */},{key:\"hasNoText\",value:function hasNoText(message){return this.hasText('',message);}/**\n     * Assert that the text of the {@link HTMLElement} or an {@link HTMLElement}\n     * matching the `selector` contains the given `text`, using the\n     * [`textContent`](https://developer.mozilla.org/en-US/docs/Web/API/Node/textContent)\n     * attribute.\n     *\n     * > Note: This assertion will collapse whitespace in `textContent` before searching.\n     * > If you would like to assert on a string that *should* contain line breaks, tabs,\n     * > more than one space in a row, or starting/ending whitespace, use the {@link #hasText}\n     * > selector and pass your expected text in as a RegEx pattern.\n     *\n     * **Aliases:** `containsText`, `hasTextContaining`\n     *\n     * @param {string} text\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('#title').includesText('Welcome');\n     *\n     * @see {@link #hasText}\n     */},{key:\"includesText\",value:function includesText(text,message){var element=this.findTargetElement();if(!element)return this;var collapsedText=collapseWhitespace(element.textContent||'');var result=collapsedText.indexOf(text)!==-1;var actual=collapsedText;var expected=text;if(!message){message=\"Element \".concat(this.targetDescription,\" has text containing \\\"\").concat(text,\"\\\"\");}if(!result&&text!==collapseWhitespace(text)){console.warn('The `.includesText()`, `.containsText()`, and `.hasTextContaining()` assertions collapse whitespace. The text you are checking for contains whitespace that may have made your test fail incorrectly. Try the `.hasText()` assertion passing in your expected text as a RegExp pattern. Your text:\\n'+text);}this.pushResult({result:result,actual:actual,expected:expected,message:message});return this;}},{key:\"containsText\",value:function containsText(expected,message){return this.includesText(expected,message);}},{key:\"hasTextContaining\",value:function hasTextContaining(expected,message){return this.includesText(expected,message);}/**\n     * Assert that the text of the {@link HTMLElement} or an {@link HTMLElement}\n     * matching the `selector` does not include the given `text`, using the\n     * [`textContent`](https://developer.mozilla.org/en-US/docs/Web/API/Node/textContent)\n     * attribute.\n     *\n     * **Aliases:** `doesNotContainText`, `doesNotHaveTextContaining`\n     *\n     * @param {string} text\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('#title').doesNotIncludeText('Welcome');\n     */},{key:\"doesNotIncludeText\",value:function doesNotIncludeText(text,message){var element=this.findTargetElement();if(!element)return this;var collapsedText=collapseWhitespace(element.textContent||'');var result=collapsedText.indexOf(text)===-1;var expected=\"Element \".concat(this.targetDescription,\" does not include text \\\"\").concat(text,\"\\\"\");var actual=expected;if(!result){actual=\"Element \".concat(this.targetDescription,\" includes text \\\"\").concat(text,\"\\\"\");}if(!message){message=expected;}this.pushResult({result:result,actual:actual,expected:expected,message:message});return this;}},{key:\"doesNotContainText\",value:function doesNotContainText(unexpected,message){return this.doesNotIncludeText(unexpected,message);}},{key:\"doesNotHaveTextContaining\",value:function doesNotHaveTextContaining(unexpected,message){return this.doesNotIncludeText(unexpected,message);}/**\n     * Assert that the `value` property of an {@link HTMLInputElement} matches\n     * the `expected` text or regular expression.\n     *\n     * If no `expected` value is provided, the assertion will fail if the\n     * `value` is an empty string.\n     *\n     * @param {string|RegExp|object?} expected\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input.username').hasValue('HSimpson');\n  \n     * @see {@link #hasAnyValue}\n     * @see {@link #hasNoValue}\n     */},{key:\"hasValue\",value:function hasValue(expected,message){var element=this.findTargetElement();if(!element)return this;if(arguments.length===0){expected={any:true};}var value=element.value;if(expected instanceof RegExp){var result=expected.test(value);var actual=value;if(!message){message=\"Element \".concat(this.targetDescription,\" has value matching \").concat(expected);}this.pushResult({result:result,actual:actual,expected:expected,message:message});}else if(expected.any===true){var _result10=Boolean(value);var _expected7=\"Element \".concat(this.targetDescription,\" has a value\");var _actual8=_result10?_expected7:\"Element \".concat(this.targetDescription,\" has no value\");if(!message){message=_expected7;}this.pushResult({result:_result10,actual:_actual8,expected:_expected7,message:message});}else{var _actual9=value;var _result11=_actual9===expected;if(!message){message=\"Element \".concat(this.targetDescription,\" has value \\\"\").concat(expected,\"\\\"\");}this.pushResult({result:_result11,actual:_actual9,expected:expected,message:message});}return this;}/**\n     * Assert that the `value` property of an {@link HTMLInputElement} is not empty.\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input.username').hasAnyValue();\n     *\n     * @see {@link #hasValue}\n     * @see {@link #hasNoValue}\n     */},{key:\"hasAnyValue\",value:function hasAnyValue(message){return this.hasValue({any:true},message);}/**\n     * Assert that the `value` property of an {@link HTMLInputElement} is empty.\n     *\n     * **Aliases:** `lacksValue`\n     *\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input.username').hasNoValue();\n     *\n     * @see {@link #hasValue}\n     * @see {@link #hasAnyValue}\n     */},{key:\"hasNoValue\",value:function hasNoValue(message){return this.hasValue('',message);}},{key:\"lacksValue\",value:function lacksValue(message){return this.hasNoValue(message);}/**\n     * Assert that the target selector selects only Elements that are also selected by\n     * compareSelector.\n     *\n     * @param {string} compareSelector\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('p.red').matchesSelector('div.wrapper p:last-child')\n     */},{key:\"matchesSelector\",value:function matchesSelector(compareSelector,message){var targetElements=this.findElements();var targets=targetElements.length;var matchFailures=_matchesSelector(targetElements,compareSelector);var singleElement=targets===1;var selectedByPart=this.selectedBy;var actual;var expected;if(matchFailures===0){// no failures matching.\nif(!message){message=singleElement?\"The element \".concat(selectedByPart,\" also matches the selector \").concat(compareSelector,\".\"):\"\".concat(targets,\" elements, \").concat(selectedByPart,\", also match the selector \").concat(compareSelector,\".\");}actual=expected=message;this.pushResult({result:true,actual:actual,expected:expected,message:message});}else{var difference=targets-matchFailures;// there were failures when matching.\nif(!message){message=singleElement?\"The element \".concat(selectedByPart,\" did not also match the selector \").concat(compareSelector,\".\"):\"\".concat(matchFailures,\" out of \").concat(targets,\" elements \").concat(selectedByPart,\" did not also match the selector \").concat(compareSelector,\".\");}actual=singleElement?message:\"\".concat(difference,\" elements matched \").concat(compareSelector,\".\");expected=singleElement?\"The element should have matched \".concat(compareSelector,\".\"):\"\".concat(targets,\" elements should have matched \").concat(compareSelector,\".\");this.pushResult({result:false,actual:actual,expected:expected,message:message});}return this;}/**\n     * Assert that the target selector selects only Elements that are not also selected by\n     * compareSelector.\n     *\n     * @param {string} compareSelector\n     * @param {string?} message\n     *\n     * @example\n     * assert.dom('input').doesNotMatchSelector('input[disabled]')\n     */},{key:\"doesNotMatchSelector\",value:function doesNotMatchSelector(compareSelector,message){var targetElements=this.findElements();var targets=targetElements.length;var matchFailures=_matchesSelector(targetElements,compareSelector);var singleElement=targets===1;var selectedByPart=this.selectedBy;var actual;var expected;if(matchFailures===targets){// the assertion is successful because no element matched the other selector.\nif(!message){message=singleElement?\"The element \".concat(selectedByPart,\" did not also match the selector \").concat(compareSelector,\".\"):\"\".concat(targets,\" elements, \").concat(selectedByPart,\", did not also match the selector \").concat(compareSelector,\".\");}actual=expected=message;this.pushResult({result:true,actual:actual,expected:expected,message:message});}else{var difference=targets-matchFailures;// the assertion fails because at least one element matched the other selector.\nif(!message){message=singleElement?\"The element \".concat(selectedByPart,\" must not also match the selector \").concat(compareSelector,\".\"):\"\".concat(difference,\" elements out of \").concat(targets,\", \").concat(selectedByPart,\", must not also match the selector \").concat(compareSelector,\".\");}actual=singleElement?\"The element \".concat(selectedByPart,\" matched \").concat(compareSelector,\".\"):\"\".concat(matchFailures,\" elements did not match \").concat(compareSelector,\".\");expected=singleElement?message:\"\".concat(targets,\" elements should not have matched \").concat(compareSelector,\".\");this.pushResult({result:false,actual:actual,expected:expected,message:message});}return this;}/**\n     * Assert that the tagName of the {@link HTMLElement} or an {@link HTMLElement}\n     * matching the `selector` matches the `expected` tagName, using the\n     * [`tagName`](https://developer.mozilla.org/en-US/docs/Web/API/Element/tagName)\n     * property of the {@link HTMLElement}.\n     *\n     * @param {string} expected\n     * @param {string?} message\n     *\n     * @example\n     * // <h1 id=\"title\">\n     * //   Title\n     * // </h1>\n     *\n     * assert.dom('#title').hasTagName('h1');\n     */},{key:\"hasTagName\",value:function hasTagName(tagName,message){var element=this.findTargetElement();var actual;var expected;if(!element)return this;if(typeof tagName!=='string'){throw new TypeError(\"You must pass a string to \\\"hasTagName\\\". You passed \".concat(tagName,\".\"));}actual=element.tagName.toLowerCase();expected=tagName.toLowerCase();if(actual===expected){if(!message){message=\"Element \".concat(this.targetDescription,\" has tagName \").concat(expected);}this.pushResult({result:true,actual:actual,expected:expected,message:message});}else{if(!message){message=\"Element \".concat(this.targetDescription,\" does not have tagName \").concat(expected);}this.pushResult({result:false,actual:actual,expected:expected,message:message});}return this;}/**\n     * Assert that the tagName of the {@link HTMLElement} or an {@link HTMLElement}\n     * matching the `selector` does not match the `expected` tagName, using the\n     * [`tagName`](https://developer.mozilla.org/en-US/docs/Web/API/Element/tagName)\n     * property of the {@link HTMLElement}.\n     *\n     * @param {string} expected\n     * @param {string?} message\n     *\n     * @example\n     * // <section id=\"block\">\n     * //   Title\n     * // </section>\n     *\n     * assert.dom('section#block').doesNotHaveTagName('div');\n     */},{key:\"doesNotHaveTagName\",value:function doesNotHaveTagName(tagName,message){var element=this.findTargetElement();var actual;var expected;if(!element)return this;if(typeof tagName!=='string'){throw new TypeError(\"You must pass a string to \\\"doesNotHaveTagName\\\". You passed \".concat(tagName,\".\"));}actual=element.tagName.toLowerCase();expected=tagName.toLowerCase();if(actual!==expected){if(!message){message=\"Element \".concat(this.targetDescription,\" does not have tagName \").concat(expected);}this.pushResult({result:true,actual:actual,expected:expected,message:message});}else{if(!message){message=\"Element \".concat(this.targetDescription,\" has tagName \").concat(expected);}this.pushResult({result:false,actual:actual,expected:expected,message:message});}return this;}/**\n     * @private\n     */},{key:\"pushResult\",value:function pushResult(result){this.testContext.pushResult(result);}/**\n     * Finds a valid HTMLElement from target, or pushes a failing assertion if a valid\n     * element is not found.\n     * @private\n     * @returns (HTMLElement|null) a valid HTMLElement, or null\n     */},{key:\"findTargetElement\",value:function findTargetElement(){var el=(0,dom_element_descriptors__WEBPACK_IMPORTED_MODULE_0__.resolveDOMElement)(this.descriptor);if(el===null){var message=\"Element \".concat(this.targetDescription,\" should exist\");this.pushResult({message:message,result:false,actual:undefined,expected:undefined});return null;}return el;}/**\n     * Finds a collection of Element instances from target using querySelectorAll\n     * @private\n     * @returns (Element[]) an array of Element instances\n     * @throws TypeError will be thrown if target is an unrecognized type\n     */},{key:\"findElements\",value:function findElements(){return Array.from((0,dom_element_descriptors__WEBPACK_IMPORTED_MODULE_0__.resolveDOMElements)(this.descriptor));}/**\n     * @private\n     */},{key:\"targetDescription\",get:function get(){var _resolveDescription;return(_resolveDescription=(0,dom_element_descriptors__WEBPACK_IMPORTED_MODULE_0__.resolveDescription)(this.descriptor))!==null&&_resolveDescription!==void 0?_resolveDescription:'undefined';}/**\n     * @private\n     */},{key:\"selectedBy\",get:function get(){if(this.wasPassedElement){return'passed';}else if((0,dom_element_descriptors__WEBPACK_IMPORTED_MODULE_0__.resolveDOMElement)(this.descriptor)){return\"selected by \".concat(this.targetDescription);}else{return'selected by null';}}}]);}();var _getRootElement=function _getRootElement(){return null;};function overrideRootElement(fn){_getRootElement=fn;}function getRootElement(){return _getRootElement();}function install(assert){assert.dom=function(target,rootElement){if(!isValidRootElement(rootElement)){throw new Error(\"\".concat(rootElement,\" is not a valid root element\"));}rootElement=rootElement||this.dom.rootElement||getRootElement();return new DOMAssertions(target!==undefined?target:rootElement instanceof Element?rootElement:null,rootElement,this);};function isValidRootElement(element){return!element||_typeof(element)==='object'&&typeof element.querySelector==='function'&&typeof element.querySelectorAll==='function';}}function setup(assert){var options=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};install(assert);var getRootElement=typeof options.getRootElement==='function'?options.getRootElement:function(){return document.querySelector('#ember-testing');};overrideRootElement(getRootElement);}\n\n//# sourceURL=webpack://__ember_auto_import__/./node_modules/.pnpm/qunit-dom@3.2.0/node_modules/qunit-dom/dist/es/index.js?");
