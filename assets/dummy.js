  ...
  /*
    ...
    >
      ...
      <div class="fx-col fx-gap-px-24">
        ...
        <OSS::Stats::Banner
          @badge={{hash icon="fa-check" skin="success"}}
          @statValue={{hash label="123,456eazneazeazjezajekzakjezajkeajkeazjk" suffix="Potatoes"}}
        >
          <:title>
            title goes here
          </:title>
