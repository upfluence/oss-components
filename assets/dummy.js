...
;define("dummy/components/panel/example-row", ["exports", "@ember/component", "@glimmer/component", "@ember/template-factory"], function (_exports, _component, _component2, _templateFactory) {
  "use strict";
  ...
  */
  ...
  class PanelExampleRow extends _component2.default {}
  _exports.default = PanelExampleRow;
  (0, _component.setComponentTemplate)(__COLOCATED_TEMPLATE__, PanelExampleRow);
});
    ...
    >
      ...
      <div class="fx-col fx-gap-px-24">
        ...
        <div class="fx-row fx-gap-px-12">
          ...
          >
            <:illustration>
              <img width="100" height="100" src="/assets/images/brand-icon.svg" />
            </:illustration>
          </OSS::Marketing::Banner>
          <OSS::Marketing::Banner
            @title="Connect Your Socials, We’ll Find the Perfect Fit within 3,500+ opportunities! 🎯"
      ...
      <div class="fx-row fx-gap-px-24 fx-xalign-start">
        <div class="fx-row fx-1 fx-gap-px-12">
          ...
          <OSS::Select
            ...
            @action={{(hash
              skin="tertiary" label="Add Hero (close on click)" icon="fa-plus" onClick=this.onFooterButtonClick
            )}}
            class="fx-1"
          >
            <:option as |item|>
    ...
    >
      ...
      <div class="fx-col fx-gap-px-12">
        <div class="fx-row fx-gap-px-6 fx-xalign-center">
          <div class="font-weight-semibold" style="width: 210px;">
      ...
      <div class="fx-row fx-gap-px-24 fx-xalign-start">
        <div class="fx-col fx-gap-px-12">
          ...
          <OSS::Smart::Button
            @skin="primary"
            @label="Primary"
            @iconUrl="/assets/images/brand-icon.svg"
          />
  ...
  /*
    ...
    >
      ...
      <div class="fx-col fx-gap-px-24">
        ...
        <div class="fx-row fx-xalign-center" style="overflow-x: auto;">
